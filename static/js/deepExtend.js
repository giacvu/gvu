...
//return function underscoreDeepExtend (obj) {
    ...
    _.mixin({deepExtend: underscoreDeepExtend});


    /*
    console.log("TESTING DEEP EXTEND");
    var object1 = {"name":{"first":"Bugs", "last":"Bunny"}};
    var object2 = {"name":{"middle":"Tee"}};
    var object3 = {};

    _.deepExtend(object3, object1, object2);

    console.log("object3 = " + JSON.stringify(object3));
    */

    return underscoreDeepExtend;
